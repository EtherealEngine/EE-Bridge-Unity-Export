...
namespace SeinJS
{
    ...
    public class Config
    {
        ...
        public static string GeneratorName = "XREngine Unity Exporter";
		...
		public static void Load()
		{
			...
			header.LoadImage(File.ReadAllBytes(Path.Combine(AppDataPath, "./_XREngine_/SeinJS/SeinJSUnityToolkit/logo.jpg")));
			header.Apply();
		}
